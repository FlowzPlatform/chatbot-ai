...
const addNlp = function addNlp(cb) {
  ...
  this.message.nlp = (0, _compromise2.default)(date_clean_string);
  cb();
};
...
const hasExpression = function hasExpression(cb) {
  ...
  const nlp2 = (0, _compromise2.default)(burstSentence);
  this.message.numbers = nlp2.match('#Value').out('array');
  this.message.numbers = this.message.numbers.map(function (x) {
    return +x;
  });

  // Special case "half" is really .5 and a number
  if (_lodash2.default.indexOf(this.message.words, "half") !== -1) {
